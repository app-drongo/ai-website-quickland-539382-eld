...
const DEFAULT_HERO = {
  badge: 'New: AI-Powered Landing Pages',
  title: 'Build stunning landing pages in',
  titleHighlight: 'minutes, not hours',
  description:
    "QuickLand's intelligent builder creates high-converting landing pages with zero coding. Perfect for startups, marketers, and agencies who need results fast.",
  features: [
  ...
  imageUrl:
    'https://images.unsplash.com/photo-1551650975-87deedd944c3?q=80&w=1920&auto=format&fit=crop',
  imageAlt: 'QuickLand dashboard interface',
  statsLabel1: 'Build Time',
  statsValue1: '< 5 minutes',
  statsLabel2: 'Conversion',
  statsValue2: '+127% avg',
} as const;
