...
export default function Footer({
  logoText = 'QuickLand',
  companyDescription = 'The fastest way to create stunning landing pages. Build, customize, and launch professional websites in minutes with our intuitive drag-and-drop builder.',
  contactEmail = 'hello@quickland.com',
  contactPhone = '+1 (555) 123-4567',
  contactAddress = '123 Innovation Drive, San Francisco, CA 94105',
  newsletterTitle = 'Stay in the Loop',
  newsletterDisclaimer = 'Get the latest templates, features, and design tips. Unsubscribe anytime.',
  section1Title = 'Platform',
  section2Title = 'Company',
  section3Title = 'Support',
  section4Title = 'Legal',
  copyrightText = '© 2024 QuickLand. All rights reserved.',
  madeWithText = 'with passion in San Francisco',
  socialText = 'Follow us:',
  social1Href = 'https://twitter.com/quickland',
  social2Href = 'https://facebook.com/quickland',
  social3Href = 'https://instagram.com/quickland',
  social4Href = 'https://linkedin.com/company/quickland',
  social5Href = 'https://github.com/quickland',
}: FooterProps) {
